module.exports = {
  ...
  extends: [
    ...
    "plugin:import/recommended", // disable prettier highlighting in code
    "plugin:import/recommended",
    "plugin:jsx-a11y/recommended",
    "plugin:typescript-sort-keys/recommended",
    "prettier" // prettier must be the last in extends
  ],
  settings: {
    react: {
    ...
    "no-restricted-imports": [
      "error",
      {
        patterns: [
          {
            group: ["/#feature/*/*"],
            message: "Please use imports only from feature's index.ts file"
          },
          {
            group: ["/#pages/*/*"],
